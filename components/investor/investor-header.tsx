...
import { Bell, Search, ChevronDown, User, Key, LogOut } from "lucide-react";
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50">
              ...
              <div className="py-1">
                ...
                <button className="w-full px-4 py-2.5 text-left flex items-center gap-3 hover:bg-red-50 text-red-600">
