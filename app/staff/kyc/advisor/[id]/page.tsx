...
export default function PendingAdvisorKycPlaceholder({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-[40vh] flex flex-col items-center justify-center space-y-4 px-4">
      <p className="text-[15px] font-semibold text-slate-900 text-center">
        Thẩm định Advisor (ID: {id})
      </p>
      <p className="text-[13px] text-slate-500 text-center max-w-md">
        Trang chi tiết thẩm định Advisor đang được nối với API. Tạm thời quay lại danh sách để xem các hồ sơ chờ.
      </p>
      <Link
        href="/staff/kyc"
