    ...
    return (
        <StartupShell>
            ...
            <div className="max-w-[760px] mx-auto space-y-5 pb-20">
                ...
                {/* ── Page header ── */}
                <div className="mb-6">
                    <h1 className="text-[22px] font-semibold text-[#0f172a] tracking-[-0.02em]">Cài đặt tài khoản & Bảo mật</h1>
                    <p className="text-[13px] text-slate-500 mt-1">Quản lý mật khẩu và cách bạn nhận các cập nhật quan trọng từ nền tảng.</p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200/80 shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between">
                        <p className="text-[12px] text-slate-400">
                            {isDirty ? "Bạn có thay đổi chưa được lưu." : "Tất cả thay đổi đã được lưu."}
                        </p>
                        <button
