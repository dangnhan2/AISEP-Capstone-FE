...
function CreateReportContent() {
  ...
  if (!session) return (
    <div className="flex flex-col items-center justify-center py-20 text-slate-400">
      ...
      <p className="text-[14px] font-semibold">Không tìm thấy thông tin buổi tư vấn</p>
    </div>
  );
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2.5 flex-wrap">
              <h1 className="text-[20px] font-bold text-slate-900 leading-tight">Soạn báo cáo: {session.objective}</h1>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[10px] font-bold border border-blue-200 bg-blue-50 text-blue-700 uppercase tracking-widest">
